                                  ...
                                  LLVMValueRef *args, uint32 *args_num)
{
    ...
    struct trace_exec_op_assembler assemblers[OPCODE_KIND_AMOUNT] = {
        ...
        [IMM_i32_OP_i32_i32] = { trace_exec_assemble_imm_i32,
                                 trace_exec_assemble_opd_i32_i32 },
                             ...
                             uint8 *ip)
{
    ...
    else if (opcode == WASM_OP_MISC_PREFIX) {
        opcode_name = misc_info[ext_opcode].opcode_name;
        opcode_kind = misc_info[ext_opcode].kind;
    }
    else {
                  ...
                  struct trace_exec_instruction *instr)
{
    struct trace_exec_op_pprinter pprinter[OPCODE_KIND_AMOUNT] = {
        ...
        [IMM_i32_OP_i32_i32] = { pprint_i32, pprint_i32_i32 },
