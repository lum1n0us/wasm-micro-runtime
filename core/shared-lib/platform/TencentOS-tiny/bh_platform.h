...
/* Platform name */
#define BH_PLATFORM "TencentOS-tiny"
...
typedef k_task_t korp_thread;
typedef korp_thread *korp_tid;
typedef k_task_t *tso_tiny_tid_t;
typedef k_mutex_t korp_mutex;
typedef k_sem_t korp_sem;

struct bh_thread_wait_node;
typedef struct bh_thread_wait_node *bh_thread_wait_list;
typedef struct korp_cond {
  k_mutex_t wait_list_lock;
